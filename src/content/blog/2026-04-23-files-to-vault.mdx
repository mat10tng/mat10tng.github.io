...
<Section>
<div slot="insight">
## 2. The Bootloader (e.g. `CLAUDE.md`)

Project configuration is the starting point for automation. Defining the system's operating environment in a bootloader file ensures the model initializes correctly with the correct logging and context rules.
</div>
...
Initial setup involves creating the directory structure and establishing a bootloader rule to prevent context loss.
</div>
</Section>
